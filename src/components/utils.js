...
query getApplications($condition:ApplicationCondition) {
    ...
    nodes{
      ...
      applicationStatus
      approvalDistance
      approvalTerminationCity
      approvalTerminationCountry
      assignedMohId
      assistantDriver
      cargoNature
      clientDetails
